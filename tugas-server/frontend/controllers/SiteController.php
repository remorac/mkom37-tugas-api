...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if (!Yii::$app->user->identity->payment_status) {
            Yii::$app->user->logout();
            Yii::$app->session->setFlash('error', 'Anda belum terdaftar sebagai user premium. Silahkan lakukan pembayaran terlebih dahulu di bank terdekat.');
